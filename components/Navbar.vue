<template>
    <nav class="fixed top-0 left-0 z-20 w-full bg-white border-b-4 border-gray-200 dark:bg-gray-900 dark:border-gray-900">
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
            <a href="https://flowbite.com/" class="flex items-center">
                <Icon name="bxs:camera-movie" class="mr-3 text-3xl text-yellow-300 " />

                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">MoviesLib</span>
            </a>
            <div class="flex justify-between space-x-1 md:space-x-4 lg:space-x-5 md:order-2">
                ...
                <button @click="toggleDark()">
                    <span v-if="!isDark">
                        <Icon name="material-symbols:wb-sunny"
                            class="text-2xl text-gray-800 xl:text-lg hover:text-gray-600 dark:text-gray-300" />

                    </span>

                    <span v-else>
                        <Icon name="fa6-solid:moon" class="text-2xl text-gray-300 xl:text-lg hover:text-white" />
