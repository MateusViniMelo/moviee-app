<template>
  ...
  >
    ...
    <div class="px-4 py-3">
      ...
      <div
        class="flex flex-wrap items-center justify-between lg:space-y-2 xl:lg:space-y-0"
      >
        <StarRating :nota="filme?.vote_average" />
      </div>
      <div
        class="flex flex-wrap items-end justify-end mt-4 space-x-1 space-y-2"
      >
        <div
          v-for="genero in generosFilmes"
          :key="genero.id"
