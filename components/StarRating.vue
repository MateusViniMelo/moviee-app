<template>
    <div class="flex items-center">
        <Icon v-for="estrela in estrelas" :name="estrela.icone" :class="estrela.classe" />


        <p class="ml-2 text-sm font-bold text-gray-900 dark:text-white">{{ notaConvertida?.toFixed(1) }}</p>
...
<style scoped></style>~/enums/iconesEstrela